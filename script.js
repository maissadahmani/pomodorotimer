...
shortBreakBtn.addEventListener("click", () => {
    document.getElementById("timer").style.backgroundColor = "rgb(193, 119, 131, 0.8) ";
    active="short";
  removeFocus();
...
longBreakBtn.addEventListener("click", () => {
    document.getElementById("timer").style.backgroundColor = "rgb(180, 111, 123, 0.8)"; /*rgb(199, 121, 134)*/
    active="long";
  removeFocus();
...
longSessionBtn.addEventListener("click", () => {
  ...
  count = 59;
  time.textContent = `${minCount + 1}:00`;
  document.getElementById("timer").style.backgroundColor = "rgb(233, 164, 175, 0.9) ";
...
shortBreakBtn.addEventListener("click", () => {
    document.getElementById("timer").style.backgroundColor = "rgb(218, 142, 154,0.9) ";
    active="short";
  removeFocus();
  shortBreakBtn.classList.add("btn-focus");
  pauseTimer();
...
longBreakBtn.addEventListener("click", () => {
    document.getElementById("timer").style.backgroundColor = "rgb(192, 95, 112,0.9)"; /*rgb(199, 121, 134)*/
    active="long";
  removeFocus();
  longBreakBtn.classList.add("btn-focus");
  pauseTimer();
